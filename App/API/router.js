...
var Midd = require("./middleware/midd_route");
...
app.post('/create-order', Midd.create_order, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
app.post('/create-recipe', Midd.create_recipe, function (req, res) {
    Contr.createRecipe(req, res);
});
//ROTTA PER LA MODIFICA DELLA QUANTITÀ DI UN ALIMENTO IN MAGAZZINO
app.post('/update-storage', Midd.update_storage, function (req, res) {
